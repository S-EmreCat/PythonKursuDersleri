...
""" 
#Stack Plot  # oyuncu1 8 gol atmış  oyuncu2 7 gol atmış üstüne ekleyerek grafikte gösteriyor (8-15 arasını kapsıyor)
...
goals=[12,35,7]
color=["y","r","b"]
# gölgelendirme ve dilimler arasında boşluk için explode
# dilimlerin üzerine yüzdeleri yazdırmak için autopct
plt.pie(goals ,labels=goal_types , colors=color,shadow=True,explode=(0.05,0.05,0.05),autopct="%1.1f%%") 
plt.show()
 """
...
# Histogram 
yaslar = [22,55,62,45,21,22,34,42,42,4,2,12,95,85,55,11,12,70,65,55,13,15,80,75,65,54,44,43,42,48]
